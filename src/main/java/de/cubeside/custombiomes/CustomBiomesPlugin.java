...
public class CustomBiomesPlugin extends JavaPlugin {
    ...
    public void onLoad() {
        ...
        nmsUtils.getBiomeUtils().registerCustomBiome(new NamespacedKey("cubeside", "dreary"), 0.5f, 0.8f, Precipitation.RAIN, 0xd9dee6, 0x818ca2, 0x171721, 0xafb8c9, 0x6b7c62, 0x899783);
    }
}
